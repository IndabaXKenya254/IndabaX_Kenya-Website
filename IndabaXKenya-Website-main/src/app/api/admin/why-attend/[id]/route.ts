// ═══════════════════════════════════════════════════════════════════════
// ADMIN API - WHY ATTEND CARD - Individual Operations
// ═══════════════════════════════════════════════════════════════════════
...
export async function GET(
  ...
  try {
    ...
    console.error('Admin why attend GET error:', error);
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    console.error('Admin why attend PUT error:', error);
    return NextResponse.json(
      { success: false, error: 'Internal server error' },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Admin why attend DELETE error:', error);
    return NextResponse.json(
      { success: false, error: 'Internal server error' },
      { status: 500 }
    );

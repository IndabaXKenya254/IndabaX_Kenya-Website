...
export const adminApi = {
  ...
  admins: {
    ...
    delete: (userId: string, deleteUser: boolean = true) =>
      apiCall(`/api/admin/admins?userId=${userId}&deleteUser=${deleteUser}`, {
        method: 'DELETE',
      }),
  },
  ...
  upload: {
    ...
    homepageImage: (file: File) => uploadFile('/api/admin/upload/homepage-image', file),

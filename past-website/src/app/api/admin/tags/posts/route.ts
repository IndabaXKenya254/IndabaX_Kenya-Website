...
// ═══════════════════════════════════════════════════════════════════════
// INDABAX KENYA - ADMIN POST TAGS API
// ═══════════════════════════════════════════════════════════════════════
// GET /api/admin/tags/posts - List all post tags
// POST /api/admin/tags/posts - Create new post tag
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      console.error('Post tags list error:', error)
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      console.error('Post tag insert error:', error)

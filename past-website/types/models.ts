...
export interface Event {
  ...
  theme?: string; // Event theme/tagline (e.g., "AI for Smart Cities")
  format?: 'physical' | 'hybrid' | 'online'; // Event format
  edition?: string; // Event edition identifier (e.g., "Strathmore Edition")
  partners?: string[]; // Array of partner/sponsor names
}

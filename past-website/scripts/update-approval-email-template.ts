/**
 * Script to update the approval email template with ticket download button
 */
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              {{#if ticket_link}}<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 25px;">
                <tr>
                  <td align="center" style="padding: 10px 0;">
                    <a href="{{ticket_link}}" style="display: inline-block; background-color: #d4af37; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 6px; font-weight: bold; font-size: 18px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">🎫 Download Your Ticket</a>
                  </td>
                </tr>
                <tr>
                  <td align="center">
                    <p style="color: #666666; font-size: 13px; margin: 10px 0 0 0;">Your ticket has been generated and is ready to download!</p>
                  </td>
                </tr>
              </table>{{/if}}
              <!-- Event Details CTA -->
              ...
              <ul style="color: #555555; font-size: 14px; line-height: 1.8; margin: 0 0 20px 0; padding-left: 20px;">
                ...
                <li>Keep your ticket safe - you'll need it for event entry</li>
                <li>Keep an eye on your email for updates about the event schedule</li>
...
async function updateTemplate() {
  console.log(`🔧 Updating approval email template...\\n`)
  ...
  console.log(`\\n📧 Changes made:`)
  console.log(`   ✅ Added ticket download button (gold background)`)
  console.log(`   ✅ Conditional rendering: only shows if ticket_link is provided`)
  console.log(`   ✅ Updated "What's Next?" section to mention ticket download`)
  console.log(`   ✅ Updated footer with correct URLs`)
}

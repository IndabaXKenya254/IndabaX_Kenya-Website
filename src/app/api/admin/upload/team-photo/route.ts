...
// ═══════════════════════════════════════════════════════════════════════
// INDABAX KENYA - TEAM PHOTO UPLOAD API
// ═══════════════════════════════════════════════════════════════════════
// POST /api/admin/upload/team-photo - Upload team member photo
// Created: Admin Enhancement - Team Photo Upload
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await uploadFile(file, 'team-photos')

...
// ═══════════════════════════════════════════════════════════════════════
// INDABAX KENYA - SITE LOGO UPLOAD API
// ═══════════════════════════════════════════════════════════════════════
// POST /api/admin/upload/site-logo - Upload site logo
// Created: Admin settings enhancement
 ...
 *
 * Max Size: 2 MB
 * Allowed Types: image/svg+xml, image/png, image/webp, image/jpeg
 */
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await uploadFile(file, 'sponsor-logos')

...
// ═══════════════════════════════════════════════════════════════════════
// INDABAX KENYA - CREATE EVENT PAGE
// ═══════════════════════════════════════════════════════════════════════
...
// Issue #39 FIX: Import SponsorSelector and TeamMemberSelector
import { TagSelector, SpeakerSelector, VenueSelector, SponsorSelector, TeamMemberSelector } from '@/components/admin/selectors'
import { EventDatesPicker } from '@/components/admin/EventDatesPicker'
import { TemplateSelector } from '@/components/admin/TemplateSelector'
import { adminApi } from '@/lib/admin/api-client'
import { showSuccess, showError, showFormError, showLoading, closeAlert, showToast, showRequiredFieldsError } from '@/lib/sweetalert'
...
export default function CreateEventPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    // Issue #39 FIX: Add missing fields from edit page
    sponsor_ids: [] as string[],
    team_member_ids: [] as string[],
    application_form_url: '',
    event_category: 'general' as 'general' | 'indabax' | 'noai',
    theme: '',
    ...
    external_link: '',
    external_link_label: '',
    // Issue #39: Registration config fields
  ...
  // Handler for rich text editor description changes
  ...
  const handleFileSelect = async (file: File) => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        showError('Upload Failed', result.error?.message || 'Failed to upload banner')
      }
    } catch (error) {
      closeAlert()
      showError('Error', 'An unexpected error occurred while uploading the banner')
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation with user-friendly field names
    ...
    try {
      ...
      const eventData: any = {
        ...
        // Issue #39 FIX: Include missing fields
      ...
      const result = await adminApi.events.create(eventData)
      closeAlert()
      ...
      if (result.success) {
        ...
        setLoading(false)
        // Use showFormError for user-friendly error display
        showFormError(result.error || 'Failed to create event', 'Creation Failed')
      }
    } catch (error) {
      closeAlert()
      setLoading(false)
      showFormError('An unexpected error occurred while creating the event', 'Creation Failed')
    }
  }
      ...
      <div className="container-fluid">
        ...
        <div className="row mb-4">
          <div className="col-md-6">
            <h2>Create Event</h2>
            <p className="text-muted">Add a new event or workshop</p>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      required
                      placeholder="e.g. IndabaX Kenya 2025"
                    />
                  </div>
                  ...
                  {/* Issue #39 FIX: Application Form URL (from edit page) */}
                  <div className="mb-3">
                  ...
                  {/* Issue #39 FIX: Sponsor Selector (from edit page) */}
                  <div className="mb-3">
                    <SponsorSelector
                  ...
                  {/* Issue #39 FIX: Team Member Selector (from edit page) */}
                  <div className="mb-3">
                    <TeamMemberSelector
                ...
                <div className="col-md-4">
                  ...
                  {/* Issue #39 FIX: Event Category (from edit page) */}
                  <div className="mb-3">
                  ...
                  {/* Weekend Configuration - Quick Setup */}
                  <div className="mb-3">
                    <label className="form-label"><strong>Quick Event Days Setup</strong></label>
                    <small className="d-block text-muted mb-2">
                      Quick config: Select which days the event runs on
                    </small>
                  ...
                  <div className="mb-3">
                    ...
                    {uploadingBanner && (
                      <div className="mt-2">
                        ...
                        <span className="text-muted small">Uploading banner...</span>
                      </div>
                    )}
                  </div>

                  {/* Issue #39 FIX: Registration Configuration */}
                        ...
                        <>
                          ...
                          <div className="mb-3">
                            <TemplateSelector
                              ...
                              label="Interest Form"
                              helperText="Form to collect interest when registration is closed"
                            />
                          </div>
